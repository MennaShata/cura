...
export class ActiveIngredientService {
  ...
  activeIngredients: Iactiveingredient[] =
    [
    { id: 0, name: 'paracetamol' , description :"Paracetamol, also known as acetaminophen or APAP, is a medicine used to treat pain and fever. It is typically used for mild to moderate pain relief",drugs:[1,2] },
