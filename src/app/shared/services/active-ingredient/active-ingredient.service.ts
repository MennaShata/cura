...
export class ActiveIngredientService {
  ...
  activeIngredients: Iactiveingredient[] =
    ...
    { id: 1, name: 'dextromethorphan',description:" is a drug of the morphinan class with sedative, dissociative, and stimulant properties (at higher doses).",drugs:[2,0,2,0,2,0],foodinteractions:[0,1,0,1,0,1],diseases:[0,1] },
