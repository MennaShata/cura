...
export class FoodInteractionService {
  foodInteractionArray: IfoodInteraction[] = [
    { id:0, foodName: 'potassium', degree: degree.minor , description:'tasalo5at w 7agat w7sha kteer', icon: 'icon-featured fa fa-edit  pull-left mr-lg'},
    ...
    { id:2, foodName: 'Vitamen C', degree: degree.moderate , description:'tasalo5at w 7agat w7sha kteer', icon: 'icon-featured fa fa-edit  pull-left mr-lg'},
